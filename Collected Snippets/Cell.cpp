...
prog_uint32_t _CellData; // one individual cell is a 32bit unsigned integer

Cell::Cell(uint32_t CellData)
{
 _CellData = CellData;
}

uint32_t Cell::getCellData()
{
  return (uint32_t)_CellData;
}
byte Cell::getByteN(int N)
{
  return (byte)_CellData>>(8*N);
}
//byte Cell::getByte1()
//{
//  return (byte)_CellData>>8;
//}
//byte Cell::getByte2()
//{
//
...
//
//}
byte Cell::setByteN(int N)
{
  _CellData = _CellData + bitmask;// TODO define bitmasks for each byte
}
//byte Cell::setByte1()
//{
//
...
//
//}
boolean Cell::hasLine()
{

}
boolean Cell::isDoorway()
{

}
boolean Cell::wasVisited()
{

}
boolean Cell::hasWall()
{
